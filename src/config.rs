...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("TianRen1".to_owned());
...
pub const LINK_DOCS_HOME: &str = "http://tianren.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "http://tianren.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/rustdesk/rustdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("tianren docs home", LINK_DOCS_HOME),
        ("tianren docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("tianren x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["183.220.81.162"];
pub const RS_PUB_KEY: &str = "rnxnKDEYhqS4C1II8yrwg6NXaipsmVhPWzlTIYbkCJ4=";
